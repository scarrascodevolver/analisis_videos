    ...
    <style>
        ...
        * {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 30px rgba(0, 183, 181, 0.3);
        }
        ...
        .hero-bg {
            ...
            bottom: 0;
            background:
                radial-gradient(ellipse at 20% 50%, rgba(0, 183, 181, 0.15) 0%, transparent 50%),
        ...
        .feature-card:hover {
            ...
            box-shadow: 0 20px 40px rgba(0, 183, 181, 0.1);
        }
        ...
        .feature-card.featured {
            border-color: rgba(0, 183, 181, 0.3);
    ...
    <nav class="navbar" id="navbar">
        <div class="navbar-container">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-ghost">Iniciar Sesion</a>
    ...
    <section class="hero">
        <div class="hero-video-bg">
            <video autoplay muted loop playsinline>
                <source src="<?php echo e(asset('images/fondo.mp4')); ?>" type="video/mp4">
            </video>
        </div>
        ...
        <div class="footer-container">
            ...
            <div class="footer-bottom">
                <p class="footer-copyright">
                    &copy; <?php echo e(date('Y')); ?> RugbyHub. Todos los derechos reservados.
                </p>
...
<?php /**PATH C:\xampp\htdocs\rugbyhub\resources\views/landing.blade.php ENDPATH**/ ?>
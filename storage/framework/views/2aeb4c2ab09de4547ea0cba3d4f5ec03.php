                ...
                <div class="card mb-3" style="background: #2a2a2a; border-color: #444;">
                    <div class="card-body">
                        ...
                        <select id="referenceClipSelect" class="form-control">
                            ...
                            <?php $__currentLoopData = $video->clips->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($clip->id); ?>" data-start="<?php echo e($clip->start_time); ?>">
                                    <?php echo e($clip->category->name ?? 'Sin categoría'); ?> - <?php echo e($clip->name ?? 'Clip sin nombre'); ?> (<?php echo e(gmdate('i:s', $clip->start_time)); ?>)
                                </option>
                        ...
                        <div class="card" style="background: #2a2a2a; border-color: #444;">
                            <div class="card-header bg-rugby-dark">
                                <h6 class="mb-0 text-white">
                                    <i class="fas fa-video"></i> Master (<?php echo e($video->camera_angle ?? 'Tribuna Central'); ?>)
                                </h6>
                            </div>
                            <div class="card-body p-2">
                                <video id="syncMasterVideo" controls style="width: 100%; max-height: 400px; background: #000;">
                                    <source src="<?php echo e(route('videos.stream', $video->id)); ?>" type="video/mp4">
                                </video>
                                <div class="mt-2">
...
<?php /**PATH C:\xampp\htdocs\rugbyhub\resources\views/videos/partials/sync-modal.blade.php ENDPATH**/ ?>
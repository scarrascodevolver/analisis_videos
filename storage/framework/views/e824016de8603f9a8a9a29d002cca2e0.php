...
$(document).ready(function() {
    ...
    function uploadMultipart(file, formData) {
        ...
        $.ajax({
            url: '<?php echo e(route("api.upload.multipart.initiate")); ?>',
            method: 'POST',
            data: {
                _token: '<?php echo e(csrf_token()); ?>',
                filename: file.name,
    ...
    function uploadPartsInParallel(file, formData, uploadId, s3UploadId, chunkSize, totalParts) {
        ...
        function uploadNextPart() {
            ...
            $.ajax({
                url: '<?php echo e(route("api.upload.multipart.part-urls")); ?>',
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    upload_id: uploadId,
    ...
    function completeMultipartUpload(uploadId, parts, formData) {
        ...
        $.ajax({
            url: '<?php echo e(route("api.upload.multipart.complete")); ?>',
            method: 'POST',
            data: confirmData,
            success: function(response) {
                if (response.success) {

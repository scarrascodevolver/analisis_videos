<?php $__env->startSection('page_title', 'Editor de Jugadas'); ?>
...
<link rel="stylesheet" href="<?php echo e(asset('jugadas-static/css/jugadas.css')); ?>">
...
<script src="<?php echo e(asset('jugadas-static/js/app.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/field.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/players.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/ball.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/movements.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/animation.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/passes.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/formations.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/storage.js')); ?>"></script>
<script src="<?php echo e(asset('jugadas-static/js/events.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rugbyhub\resources\views/jugadas/index.blade.php ENDPATH**/ ?>
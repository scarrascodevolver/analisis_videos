    ...
    <?php
        ...
        $orgFavicon =
            $currentOrganization && $currentOrganization->logo_path
                ...
                : asset('favicon.png');
    ?>
    <title><?php echo $__env->yieldContent('page_title', 'Dashboard'); ?> - <?php echo e($orgName); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e($orgFavicon); ?>">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(route('videos.index')); ?>" class="nav-link">Videos</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                ?>
                <?php if($userOrganizations->count() > 1 || $isSuperAdmin): ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                            <i class="fas fa-building mr-1"></i>
                            <?php echo e($currentOrg ? Str::limit($currentOrg->name, 15) : 'Sin org'); ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" style="max-height: 400px; overflow-y: auto;">
                            ...
                            <?php endif; ?>
                            <?php $__currentLoopData = $userOrganizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form action="<?php echo e(route('set-organization', $org)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="dropdown-item <?php echo e($currentOrg && $currentOrg->id === $org->id ? 'active bg-success' : ''); ?>">
                                        <?php if($currentOrg && $currentOrg->id === $org->id): ?>
                                        ...
                                        <?php if(!$isSuperAdmin && isset($org->pivot)): ?>
                                            <small class="text-muted ml-2">(<?php echo e(ucfirst($org->pivot->role)); ?>)</small>
                                        <?php endif; ?>
                                    </button>
                                </form>
                ...
                <?php elseif($currentOrg): ?>
                    <li class="nav-item">
                        <span class="nav-link text-light">
                            ...
                            <span class="d-none d-md-inline"><?php echo e($currentOrg->name); ?></span>
                            
                            <span class="d-inline d-md-none"><?php echo e(Str::limit($currentOrg->name, 15)); ?></span>
                        </span>
                    </li>
                <?php endif; ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header">
                            <?php echo e(auth()->user()->unreadNotifications->count()); ?> Notificaciones no leídas
                        </span>
                        <div class="dropdown-divider"></div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('videos.show', $notification->data['video_id'])); ?>?notification_id=<?php echo e($notification->id); ?>"
                                class="dropdown-item">
                                <i class="fas fa-at mr-2 text-primary"></i>
                                <strong><?php echo e($notification->data['mentioned_by_name']); ?></strong> te mencionó
                                <span class="float-right text-muted text-sm">
                                    <?php echo e($notification->created_at->diffForHumans()); ?>

                                </span>
                                <p class="text-sm text-muted mb-0 mt-1">
                                    <?php echo e(Str::limit($notification->data['comment_text'], 50)); ?>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php echo e(route('videos.index')); ?>" class="brand-link d-flex justify-content-center py-3">
                <img src="<?php echo e($orgLogo); ?>" alt="<?php echo e($orgName); ?> Logo" class="brand-logo-full"
                    style="width: 120px; height: auto; object-fit: contain;">
                <img src="<?php echo e(asset('favicon.png')); ?>" alt="<?php echo e($orgName); ?>" class="brand-logo-mini"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo e(route('profile.show')); ?>" class="text-light text-decoration-none">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        ...
                        <?php if(in_array(Auth::user()->role, ['analista', 'entrenador'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('videos.create')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('videos.create') ? 'active' : ''); ?>">
                        ...
                        <?php if(Auth::user()->role !== 'jugador' && Auth::user()->role !== 'director_club'): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('videos.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('videos.index') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-video"></i>
                                    <p>Videos del Equipo</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('my-videos')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('my-videos') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-user-circle"></i>
                                    <p>Mis Videos</p>
                                    <?php if(auth()->user()->pendingAssignments()->count() > 0): ?>
                                        <span
                                            class="badge badge-warning navbar-badge"><?php echo e(auth()->user()->pendingAssignments()->count()); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        <?php endif; ?>

                        <?php if(Auth::user()->role === 'director_club'): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('videos.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('videos.index') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-video"></i>
                        ...
                        <?php if(Auth::user()->role === 'jugador'): ?>
                            ...
                            <?php if($canEvaluate): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('evaluations.index')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('evaluations.index') || request()->routeIs('evaluations.wizard') || request()->routeIs('evaluations.store') ? 'active' : ''); ?>">
                            ...
                            <?php endif; ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('evaluations.dashboard')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('evaluations.dashboard') || request()->routeIs('evaluations.show') ? 'active' : ''); ?>">
                        ...
                        <?php if(Auth::user()->role === 'entrenador' || Auth::user()->role === 'analista'): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('coach.users')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('coach.users') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-users"></i>
                                    <p>Jugadores</p>
                                </a>
                            </li>
                        ...
                        <?php if(in_array(Auth::user()->role, ['analista', 'entrenador'])): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('admin.organization')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('admin.organization') ? 'active' : ''); ?>">
                        ...
                        <?php if(Auth::user()->isSuperAdmin()): ?>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('super-admin.dashboard')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('super-admin.dashboard') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-shield-alt text-danger"></i>
                                    <p>Panel Super Admin</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('super-admin.organizations')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('super-admin.organizations*') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('super-admin.users')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('super-admin.users') ? 'active' : ''); ?>">
                                    <i class="nav-icon fas fa-users-cog text-danger"></i>
                                    <p>Todos los Usuarios</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('super-admin.storage')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('super-admin.storage') ? 'active' : ''); ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(session('warning')): ?>
                showToast(<?php echo json_encode(session('warning'), 15, 512) ?>, 'warning');
            <?php endif; ?>
            <?php if(session('info')): ?>
                showToast(<?php echo json_encode(session('info'), 15, 512) ?>, 'info');
            <?php endif; ?>
        });
    </script>
</body>
...
<?php /**PATH C:\xampp\htdocs\rugbyhub\resources\views/layouts/app.blade.php ENDPATH**/ ?>
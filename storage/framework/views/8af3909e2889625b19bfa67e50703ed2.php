                ...
                <div class="position-relative">
                    ...
                    <div class="position-absolute" style="top: 10px; left: 10px;">
                        <span class="badge badge-primary badge-lg">
                            <i class="fas fa-video"></i> <?php echo e($video->camera_angle ?? 'Master'); ?>
...
(function() {
    ...
    function loadMultiCameraView(specificAngleId = null) {
        $.ajax({
            url: `/videos/<?php echo e($video->id); ?>/multi-camera/angles`,
            method: 'GET',
...
<?php /**PATH C:\xampp\htdocs\rugbyhub\resources\views/videos/partials/multi-camera-player.blade.php ENDPATH**/ ?>
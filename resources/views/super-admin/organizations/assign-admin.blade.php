...
<div class="container-fluid">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="background:transparent;">
                    <li class="breadcrumb-item"><a href="{{ route('super-admin.dashboard') }}" style="color:#b8860b;">Super Admin</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('super-admin.organizations') }}" style="color:#b8860b;">Organizaciones</a></li>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow" style="background:#141c22; border:1px solid #243038;">
                <div class="card-header py-3" style="background:#b8860b; border-bottom:1px solid #243038;">
                    <h6 class="m-0 font-weight-bold" style="color:#fff;">
                ...
                <div class="card-body">
                    <form action="{{ route('super-admin.organizations.create-user', $organization) }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-block" style="background:#b8860b; color:#fff;">
            ...
            <div class="card shadow" style="background:#141c22; border:1px solid #243038;">
                <div class="card-header py-3" style="background:#003d4a; border-bottom:1px solid #243038;">
                    <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap:8px;">
                        <h6 class="m-0 font-weight-bold" style="color:#fff;">
                            <i class="fas fa-users mr-2" style="color:#b8860b;"></i>

        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="background:transparent;">
                    <li class="breadcrumb-item"><a href="{{ route('super-admin.dashboard') }}" style="color:#D4A017;">Super Admin</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('super-admin.organizations') }}" style="color:#D4A017;">Organizaciones</a></li>
                    <li class="breadcrumb-item active" style="color:#aaa;">Gestionar Usuarios: {{ $organization->name }}</li>
                </ol>
            </nav>
            <h1 class="h3 mb-0" style="color:#fff;">
                <i class="fas fa-users-cog mr-2" style="color:#D4A017;"></i>
            ...
            <div class="card shadow" style="background:#141c22; border:1px solid #243038;">
                ...
                <div class="card-body">
                    <form action="{{ route('super-admin.organizations.create-user', $organization) }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-block" style="background:#D4A017; color:#fff;">

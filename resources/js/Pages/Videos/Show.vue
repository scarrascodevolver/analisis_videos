...
<template>
    ...
    <AdminLteLayout>
        ...
        <div v-if="isProcessing" class="card card-rugby text-center py-5 mx-auto" style="max-width:600px;margin-top:40px">
            <div class="card-body">
                <div class="mb-3">
                    <i class="fas fa-film fa-3x" style="color:var(--color-accent);opacity:.6"></i>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-center mb-3" style="gap:10px">
                    <div class="spinner-border spinner-border-sm" style="color:var(--color-accent)" role="status"></div>
                ...
                <div class="progress" style="height:6px;background:#2a2a2a;border-radius:3px">
                    <div class="progress-bar progress-bar-striped progress-bar-animated"
                        style="background:linear-gradient(90deg,#005461,var(--color-accent));width:100%"></div>
                </div>

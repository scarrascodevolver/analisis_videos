...
class VideoController extends Controller
{
        ...
        if ($isYoutube) {
            ...
            try {
                ...
                $video = Video::create([
                    ...
                    'mime_type' => '',
                    'uploaded_by' => auth()->id(),
                    'analyzed_team_name' => $request->local_team_name ?: null,
    ...
    public function show(Request $request, Video $video)
    {
        ...
        // Usuarios mencionables: de la org del VIDEO (no del viewer)
        // Super admins aparecen solo si están asignados explícitamente a esta org
    ...
    public function destroy(Request $request, Video $video)
    {
        ...
        // Despachar eliminación en Bunny de forma asíncrona (no bloquea la respuesta)
        if ($video->bunny_video_id) {
            \App\Jobs\DeleteBunnyVideoJob::dispatch($video->bunny_video_id, $video->organization_id);
        }

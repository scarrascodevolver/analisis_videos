...
class SyncBunnyWebhooks extends Command
{
    ...
    protected $description = 'Configura webhook URL y resoluciones (360p,480p,720p,1080p) en todas las libraries de Bunny existentes';
    ...
    public function handle(): void
    {
        ...
        foreach ($orgs as $org) {
            ...
            try {
                ...
                if ($res->successful()) {
                    $this->info("    ✓ Webhook + resoluciones (360p,480p,720p,1080p) configurados");
                } else {
